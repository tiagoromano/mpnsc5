...
@XmlRootElement
@CronappSecurity
@JsonFilter("reports.entity.TiposBancos")
public class TiposBancos implements Serializable {
  ...
  * @generated
  */
  @Column(name = "DS_TIPO_BANCO", nullable = true, unique = false, length=30, insertable=true, updatable=true)
  @CronapiSearchable
  ...
  * @generated
  */
  @Column(name = "DS_ICONE_BANCO", nullable = false, unique = false, length=30, insertable=true, updatable=true)
  @CronapiSearchable
